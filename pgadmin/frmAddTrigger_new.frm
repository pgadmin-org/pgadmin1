...
Begin VB.Form frmAddTrigger_new 
   Caption         =   "Trigger"
   ClientHeight    =   3450
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4245
   Icon            =   "frmAddTrigger_new.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3450
   ScaleWidth      =   4245
   ...
   Begin VB.ComboBox cboFunction 
      Height          =   315
      ItemData        =   "frmAddTrigger_new.frx":030A
      Left            =   1485
      List            =   "frmAddTrigger_new.frx":030C
   ...
   End
End
Attribute VB_Name = "frmAddTrigger_new"
